...
So here's what keeps me up at night, as the person running engineering teams and responsible for where the product is in a year. I'm enjoying the velocity gains as much as anyone. I'm also the one accountable when developers quit and velocity drops. When a feature is late because it touches a corner of the platform that a handful of customers use, an agent last changed a year ago, and nobody on the team wants to open. When we no longer have four nines of uptime. Sadly the conversation online only seems to be about the first six months.
