...
Uncle Bob charted the tar pit in the first chapter of [*Clean Architecture*](https://www.informit.com/store/clean-architecture-a-craftsmans-guide-to-software-structure-9780134494166): productivity per engineer falling release after release, heading for zero, while the cost of every line climbs. He calls it the signature of a mess. I'd argue that chart is the reason the book was written. In a lot of ways that book is what the job of a software developer was to me: standing up for standards and architecture, and weighing short-term gain against long-term velocity on every change.
